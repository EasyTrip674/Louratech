  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div>
        ...
        <p className="text-2xl font-bold text-gray-900 dark:text-white">{procedurePrice} FNG</p>
      </div>
      
      <div>
        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Revenus Perçus</h3>
        <p className="text-2xl font-bold text-green-600 dark:text-green-400">{totalRevenue} FNG</p>
      </div>
      
      <div>
        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Revenus en Attente</h3>
        <p className="text-2xl font-bold text-amber-500">{pendingRevenue} FNG</p>
      </div>
