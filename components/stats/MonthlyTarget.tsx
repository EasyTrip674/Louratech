...
export default function MonthlyTarget({MonthlyTargetData}:{MonthlyTargetData:getMonthlyTargetStatsType}) {
  const series = [MonthlyTargetData.progress];
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 font-normal text-gray-500 text-theme-sm dark:text-gray-400">
              Avancement par  rapport à au mois precedent
            </p>
          </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        <div>
          ...
          {formatCurrency(MonthlyTargetData.lastMonthAmount)}
        ...
        <div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
            {formatCurrency(MonthlyTargetData.revenue)}
