...
pg_dump --data-only --no-owner --no-acl  "postgresql://Production_owner:npg_PgVuO9m4fqYh@ep-long-lake-a99eer04-pooler.gwc.azure.neon.tech/Production?sslmode=require&channel_binding=require" -f last_productionnversion.sql
