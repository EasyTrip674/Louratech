...
// Composant pour vérifier les autorisations des finances
async function FinancesAuthGuard({ children }: { children: React.ReactNode }) {
  try {
    ...
    console.error("Erreur lors de la vérification des autorisations finances:", error);
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
